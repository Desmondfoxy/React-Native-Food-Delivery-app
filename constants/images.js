...
const bikeGuy = require('../assets/images/bikeGuy.png');
const delivery = require('../assets/images/delivery.gif');
const deliveryGuy = require('../assets/images/deliveryGuy.png');
const logo = require('../assets/images/logo.png');
const background = require('../assets/images/veggies-612x612.png');

const welcome_1 = require('../assets/images/food-sutherland-foodservice-12.png');
const welcome_2 = require('../assets/images/Meal-PNG-Photo.png');
const welcome_3 = require('../assets/images/Healthy-Meal-PNG.png');
