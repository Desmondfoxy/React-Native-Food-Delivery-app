...
export const bikeGuy = require('../assets/icons/bikeGuy.png');
export const bikeGuy2 = require('../assets/icons/bikeGuy2.gif');
export const delivery2 = require('../assets/icons/delivery.gif');
